...
import org.example.model.VehicleInfoDto;
...
public class VehicleInfo {
    ...
    private String interpretationAVSData;

    private String catalogCode;

    private String type;

    public static VehicleInfo convert(VehicleInfoDto dto) {
        VehicleInfo vehicleInfo = new VehicleInfo();
        BeanUtils.copyProperties(dto, vehicleInfo);
        vehicleInfo.setInterpretationAVSData(dto.getInterpretationAVSData().toJSONString(2));
        return vehicleInfo;
    }
    ...
    public String getInterpretationAVSData() {
        return interpretationAVSData;
    }

    public void setInterpretationAVSData(String interpretationAVSData) {
